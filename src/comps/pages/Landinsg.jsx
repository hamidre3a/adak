...
const Hero = () => (
  <div style={styles.heroRoot}>
    <Center>
      <Header as='h1'>مرکز ماساژ آداک</Header>
      {/* <Header as='h3'>مرکز ماساژ آداک اسپا ویژه انواع ماساژ حرفه ای</Header> */}
      <div style={{ height: 32 }} />
...
const HomepageHeading = ({ mobile }) => (
  <Container text>
    ...
    <Header
      as='h2'
      content='مرکز ماساژ آداک اسپا ویژه انواع ماساژ حرفه ای'
      inverted
      style={{
